...
export default function TagList({ tags, search, setTags }) {
    ...
    function checkboxCheckHandler(tagId) {
        if (selectedTags.includes(tagId)) { // if array includes the tag, that means tag is already selected
        ...
        <div className={sty.container}>
            ...
            <div className={sty.table_headers}>
                <Flex align={'center'} gap={8}>
                    <Checkbox indeterminate={selectedTags.length === tags.length} onChange={(e) => selectAllHandler(e)} checked={selectedTags.length === tags.length}/>
